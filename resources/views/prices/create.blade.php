<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('Create Price') }}</h2>
    </x-slot>
    <div class="py-12">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <form method="POST" action="{{ route('prices.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="currency" value="{{ old('currency', 'MXN') }}" maxlength="3" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
