            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('venues.update', $venue) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="max_fields"
                               value="{{ old('max_fields', $venue->max_fields) }}" min="1"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="match_duration_minutes"
                               value="{{ old('match_duration_minutes', $venue->match_duration_minutes) }}" min="1"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="advance_booking_days"
                               value="{{ old('advance_booking_days', $venue->advance_booking_days) }}" min="0"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
